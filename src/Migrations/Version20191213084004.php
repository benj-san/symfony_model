 ...
 */
final class Version20191213084004 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event_registration (id INT AUTO_INCREMENT NOT NULL, protagonist_id INT DEFAULT NULL, event_id INT DEFAULT NULL, registration_date DATETIME NOT NULL, INDEX IDX_8FBBAD54CDF038AD (protagonist_id), INDEX IDX_8FBBAD5471F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE event_registration ADD CONSTRAINT FK_8FBBAD54CDF038AD FOREIGN KEY (protagonist_id) REFERENCES protagonist (id)');
